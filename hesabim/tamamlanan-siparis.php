...
include 'sidebar.php';
$siparissor=$db->prepare("SELECT * from siparis where siparis_ad=:siparis_ad and siparis_durum='0'");
								...
								<tr>
									...
									<td class="text-center">
										...
										<form action="" method="POST">
											...
											<a href="<?=seo('siparis-detay-'.$userprint['uye_ad'].'-'.$userprint['uye_soyad']).'-'.$sipariscek['siparis_id']?>" title="Göster" class="btn btn-sm btn-default"><i class="fa fa-eye"></i></a>
											<button style="cursor: pointer; align-items: right" type="submit" name="siparissil" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button>
										</form>
									</td>
								</tr>
							<?php } ?>
