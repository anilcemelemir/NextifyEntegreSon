	...
	<div class="nano">
		<div class="nano-content sidebar-nav">
			<ul class="metisMenu nav flex-column" id="menu">
				...
				<li class="nav-item <?php if (strstr($link, "abone")) { echo "active";} ?>"><a class="nav-link" href="abonelikler"><i class="icon-list"></i> <span class="toggle-none">Aboneliklerim </a></li>
