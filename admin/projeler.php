			...
			<div class="card">
				<div class="card-heading card-default">
					<div class="pull-right mt-10">
						<a href="proje-kategori.php" class="btn btn-success btn-icon"><i class="fa fa-list"></i>Kategori Yönetimi</a>
						<a href="proje-yazi.php" class="btn btn-danger btn-icon"><i class="fa fa-pencil-square-o"></i> Yazı Alanı Düzenle</a>
					...
					<table id="datatable1" class="table table-striped dt-responsive nowrap table-hover">
						...
						<tbody>
							...
							while ($projecek=$projesor->fetch(PDO::FETCH_ASSOC)) {
								$eskikategori=$db->prepare("SELECT * from kategoriproje where kategori_id=:kategori_id");
								$eskikategori->execute(array(
									'kategori_id' => $projecek['kategori']
								));
								...
								<tr>
									...
									<td><?php echo $eskikategoriyaz['kategori_ad'] ?></td>
