<?php 
$yenisay=$db->prepare("SELECT * from destek where destek_adminoku='0'");
			...
			<div class="col">
				<ul class="list-inline top-right-nav">
					...
					<li class="dropdown icon-dropdown">
						<a href="destek.php"><i class="icon-earphones-alt"></i> <span class="badge badge-danger"><?php echo $yeni; ?></span></a>
					</li>
