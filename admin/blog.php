			...
			<div class="card">
				<div class="card-heading card-default">
					...
					<div class="pull-right mt-10" style="margin-right: 10px;">
						<a href="blog-kategoriler.php" class="btn btn-danger btn-icon"><i class="fa fa-list"></i>Kategori Yönetimi</a>
					</div>
					Blog Konuları
				</div>
						...
						<tbody>
							...
							while ($blogcek=$blogsor->fetch(PDO::FETCH_ASSOC)) {
								...
								<tr>
									...
									<td>
										<a target="_blank" href="<?php echo $settingsprint['ayar_siteurl']; ?><?=seo('konu-'.$kategoriwrite["kategori_ad"]).'-'.$kategoriwrite["kategori_id"]?>" title="Düzenle" class="btn btn-sm btn-warning"><i class="fa fa-external-link"></i></a> <?php echo $kategoriwrite['kategori_ad']; ?></td>
