                            ...
                            <form action="controller/function.php" method="POST">
                                <div class="form-group">
                                    ...
                                    <div class="group-icon">
                                        <input name="kullanici_adi" id="exampleuser1" type="text" placeholder="Kullanıcı adınızı giriniz." <?php if ($DemCont==1) { ?> value="admin" readonly="" <?php } ?> class="form-control" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="group-icon">
                                        <input name="kullanici_pass" id="exampleInputPassword1" type="password" placeholder="Şifrenizi giriniz." <?php if ($DemCont==1) { ?> value="admin" readonly="" <?php } ?> class="form-control">
