...
$kategorisor=$db->prepare("SELECT * from kategoripaket");
			...
			<div class="card">
				<div class="card-heading card-default">
					<div style="margin-left: 10px;" class="pull-right mt-10">
						<a href="paket-kategori-ekle.php" class="btn btn-primary btn-icon"><i class="fa fa-plus"></i> Kategori Ekle</a>
					</div>
					Kategoriler
				</div>
							...
							while ($kategoricek=$kategorisor->fetch(PDO::FETCH_ASSOC)) {
								...
								<tr>
									...
									<td class="text-center">
										...
										<a href="paket-kategori-duzenle.php?kategori_id=<?php echo $kategoricek['kategori_id']; ?>" title="Düzenle" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
										<a href="controller/function.php?paketkategorisil=ok&kategori_id=<?php echo $kategoricek['kategori_id']; ?>" title="Sil" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								<?php } ?>
							</tbody>
