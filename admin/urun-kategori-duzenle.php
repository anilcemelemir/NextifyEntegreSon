			...
			<div class="card">
				<div class="card-heading card-default">
					<div class="pull-right mt-10">
						<a href="urun-kategori.php" class="btn btn-warning btn-icon"><i class="fa fa-reply"></i>Geri Dön</a>
					</div>
					Kategori Düzenle
				</div>
				<div class="card-block">
					...
					<form method="POST" action="controller/function.php" class="form-horizontal">
						...
						<button style="cursor: pointer;" type="submit" name="urunkategoriduzenle" class="btn btn-success btn-icon"><i class="fa fa-floppy-o "></i>Güncelle</button>
					</form>
				</div>
			</div>
		</div>
